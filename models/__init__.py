...
from .hechos_ventas_model import HechosVentasModel, RangoFechas, VentaOrigen, Venta, ProductoVendido
...
__all__=[
    ...
    "HechosVentasModel", "RangoFechas", "VentaOrigen", "Venta", "ProductoVendido",
